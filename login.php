...
<head>
    ...
    <title><?= $lang['auth.connection'] ?></title>
</head>
...
<body class="container">
    ...
    <main class="mx-auto">
        <div class="container col-xl-10 col-xxl-8 px-4 py-5">
            <h1 class="display-3 fw-bold lh-1 text-body-emphasis mb-3 text-center"><?= $lang['common.petanque'] ?></h1>
            <div class="row align-items-top g-lg-5 py-5">
                <div class="col-lg-5 text-center text-lg-start">
                    <h2 class="display-4 mb-2 fw-bold"><?= $lang['auth.connect.form'] ?></h2>
                </div>
                <div class="col-md-10 mx-auto col-lg-7">
                        <form id="main-form" class="p-2 p-md-3 border rounded-3 bg-body-tertiary text-center" method="post" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                            <small class="text-body-secondary"><?= $lang['auth.required.inputs'] ?></small>
                            ...
                            <button class="w-100 btn btn-lg btn-primary" type="submit"><?= $lang['common.submit'] ?></button>
                        </form>
                </div>
            </div>
        </div>
